...
private:
    ...
    //ChatLogic *_chatLogic;  //Initial line for raw pointer
    std::unique_ptr<ChatLogic> _chatLogic; //make _chatLogic an exclusive resource to class ChatbotPanelDialog using an appropriate smart pointer
...
public:
    ...
    // getter / setter
    //ChatLogic *GetChatLogicHandle() { return *_chatLogic; }  //Initial line for raw pointer 
