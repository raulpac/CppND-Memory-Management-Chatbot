    ...
    : wxScrolledWindow(parent, id)
{
    ...
    //_chatLogic = new ChatLogic(); //Initial line for raw pointer.
    //std::unique_ptr<ChatLogic> _chatLogic = std::make_unique<ChatLogic>(); I think I was creating a new pointer
    //and it wasn't "this" _chatLogic therefore it wasn't initialized and therefore causing a segmentation fault.
    
    _chatLogic = std::make_unique<ChatLogic>(); 
    //take cares of new and delete for the object.
    //Therefore, we should remove manual elimination of _chatLogic under ChatBotPanelDialog destructor.
